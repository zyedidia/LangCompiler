...
nnoremap \t :call OpenAll('*')
nnoremap \= :call IndentFile()
...
set matchtime=1
set mouse=a
set runtimepath=~/.vim,~/.vim/bundle/addon-mw-utils,~/.vim/bundle/ctrlp,~/.vim/bundle/delimitMate,~/.vim/bundle/easymotion,~/.vim/bundle/mySnippets,~/.vim/bundle/nerdtree,~/.vim/bundle/snipmate,~/.vim/bundle/snippets,~/.vim/bundle/solarized,~/.vim/bundle/supertab,~/.vim/bundle/syntastic,~/.vim/bundle/tcomment,~/.vim/bundle/tlib,/Applications/MacVim.app/Contents/Resources/vim/vimfiles,/Applications/MacVim.app/Contents/Resources/vim/runtime,/Applications/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/bundle/snipmate/after,~/.vim/after
set scrolloff=3
set shiftwidth=4
set showcmd
set showmatch
...
set shortmess=aoO
badd +1 CodeWriter.java
badd +1 Compiler.java
badd +1 FieldTable.java
badd +1 Lang.java
badd +1 LangBaseListener.java
badd +1 LangField.java
badd +1 LangLexer.java
badd +1 LangListener.java
badd +1 LangMethod.java
badd +1 LangParser.java
badd +1 MethodFieldResolver.java
badd +1 ProgramInfo.java
badd +1 ScannerTest.java
badd +1 StdLib.java
badd +1 SubroutineTable.java
badd +1 SymbolTable.java
badd +1 TestArray.java
badd +0 TypeChecker.java
argglobal
silent! argdel *
argadd CodeWriter.java
argadd Compiler.java
argadd FieldTable.java
argadd Lang.java
argadd LangBaseListener.java
argadd LangField.java
argadd LangLexer.java
argadd LangListener.java
argadd LangMethod.java
argadd LangParser.java
argadd MethodFieldResolver.java
argadd ProgramInfo.java
argadd ScannerTest.java
argadd StdLib.java
argadd SubroutineTable.java
argadd SymbolTable.java
argadd TestArray.java
argadd TypeChecker.java
edit CodeWriter.java
...
1
normal! 0
tabedit MethodFieldResolver.java
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
